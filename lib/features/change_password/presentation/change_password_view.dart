...
import 'package:tgpl_network/features/change_password/presentation/change_password_controller.dart';
...
class _ChangePasswordViewState extends ConsumerState<ChangePasswordView> {
  ...
  Widget build(BuildContext context) {
    ...
    ref.listen(changePasswordAsyncControllerProvider, (previous, next) {
      if (next is AsyncError) {
        showSnackBar(context, next.error.toString(), bgColor: AppColors.emailUsIconColor);
      }
    });
    return Scaffold(
