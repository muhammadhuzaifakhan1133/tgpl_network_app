...
final List<AuditPage> auditPages = [
  ...
  AuditPage(pageId: 3, title: "Washroom", questions: [
    AuditQuestion(
      questionId: 10,
      questionText: "Is Washroom available on site?",
      isRequired: true,
      questionType: QuestionType.multipleChoice,
      options: [
        AuditQuestionOption(optionId: 1, optionText: "Yes", scoreValue: 1),
    ...
    AuditQuestion(
      questionId: 11,
      questionText: "Washroom is clean and well maintained",
      isRequired: false,
      questionType: QuestionType.multipleChoice,
      options: [
        AuditQuestionOption(optionId: 1, optionText: "Yes"),
        AuditQuestionOption(optionId: 2, optionText: "No",),
        AuditQuestionOption(optionId: 3, optionText: "N/A"),
      ],
      pageId: 3,
      order: 2,
      conditionQuestionId: 10,
      conditionQuestionResponseValue: "Yes",
    ),
    AuditQuestion(
      questionId: 12,
      questionText: "Picture of Washroom",
      isRequired: true,
      questionType: QuestionType.media,
      pageId: 3,
      order: 3,
